  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    if (promptFight === "skip" || promptFight === "SKIP") {
      ...
      if (confirmSkip) {
        ...
        //if true leave fight
        if (confirmSkip) {
          window.alert(playerInfo.name + "has decided to to skip this fight. Goodbye!");
          //subtract player money not into negative 
...
var fight = function (enemy) {
  ...
  while (playerInfo.health > 0 && enemy, health > 0) {
    ...
    console.log(
      ...
      //remove enemys health by subtracting the amount we set in damage variable
      ...
      //removes player's health by - the amount we set in the damage variable 
      playerInfo.health = Math.max(0, playerInfo.health - damage);
      console.log(
        enemy.name +
        " attacked " +
...
var shop = function() {
  ...
  switch (shopOptionPrompt) {
    ...
    case 3:
      ...
      // do nothing, so functioSn will end
      break;
    default:
